...
namespace mivins
{
    ...
    {
        return (t == FeatureType::kEdgeletSeedConverged || t == FeatureType::kCornerSeedConverged || t == FeatureType::kEdgeletSeed || t == FeatureType::kCornerSeed);
    }

    inline bool IsConvergedCornerEdgeletSeed(const FeatureType &t)
    {
        return (t == FeatureType::kEdgeletSeedConverged || t == FeatureType::kCornerSeedConverged);
    }
    ...
    {
        return (t == FeatureType::kEdgelet || t == FeatureType::kEdgeletSeed || t == FeatureType::kEdgeletSeedConverged);
    }

    inline bool isCorner(const FeatureType &t)
    {
        return (t == FeatureType::kCorner || t == FeatureType::kCornerSeed || t == FeatureType::kCornerSeedConverged);
    }

    inline bool isMapPoint(const FeatureType &t)
    {
        return (t == FeatureType::kMapPoint || t == FeatureType::kMapPointSeed || t == FeatureType::kMapPointSeedConverged);
    }

    inline bool isMapPointSeed(const FeatureType &t)
    {
        return (t == FeatureType::kMapPointSeed || t == FeatureType::kMapPointSeedConverged);
    }

    inline bool isUnconvergedSeed(const FeatureType &t)
    {
        return (t == FeatureType::kCornerSeed || t == FeatureType::kMapPointSeed || t == FeatureType::kEdgeletSeed);
    }
