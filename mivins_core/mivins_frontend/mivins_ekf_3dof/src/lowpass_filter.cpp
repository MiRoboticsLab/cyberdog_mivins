 ...
 */
#include "mivins/ekf_3dof/lowpass_filter.h"
...
void LowpassFilter::AddWeightedSample(const Vector3& sample,
  ...
  const double alpha =
      weighted_delta_secs / (cutoff_time_constant_ + weighted_delta_secs);
