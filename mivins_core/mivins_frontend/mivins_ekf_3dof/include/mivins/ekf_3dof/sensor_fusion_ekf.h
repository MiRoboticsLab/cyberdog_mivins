...
#include "mivins/ekf_3dof/gyroscope_bias_estimator.h"
#include "mivins/ekf_3dof/gyroscope_data.h"
#include "mivins/ekf_3dof/pose_state.h"
#include "mivins/ekf_3dof/matrix_3x3.h"
#include "mivins/ekf_3dof/rotation.h"
...
class SensorFusionEkf {
 ...
 private:
  ...
  // Covariance of Kalman filter state (P in common formulation). ״̬Э�������
  Matrix3x3 state_covariance_;
  // Covariance of the process noise (Q in common formulation). ����Э�������
  ...
  // Current prediction vector (g in common formulation). ---- Not Used
  Vector3 prediction_;
  // Control input, currently this is only the gyroscope data (\mu in common
  // formulation). ---- Not Used
