...
def generate_launch_description():
    calib_path = os.path.join(get_package_share_directory('vins'), 'param/dog_version2/dog_version2_stereo_pinhole.yaml')
    config_file = os.path.join(get_package_share_directory('vins'), 'param/dog_version2/dog_version2_stereo.yaml')
    print(calib_path) 
